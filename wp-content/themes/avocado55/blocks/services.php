...
<section class="relative py-16 lg:py-24 overflow-hidden">
  <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
    <?php if ($title) : ?>
      ...
      <h2 class="relative z-2 text-3xl lg:text-5xl font-semibold text-brand-green leading-tight max-w-5xl mb-8 [&>span]:font-semibold [&>span]:text-brand-cta <?php echo esc_attr(avocado55_animation_class(1)); ?>">
        <?php echo $title; ?>
      </h2>
